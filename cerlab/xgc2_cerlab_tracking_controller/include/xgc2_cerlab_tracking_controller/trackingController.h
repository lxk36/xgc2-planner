...
#include <xgc2_cerlab_tracking_controller/utils.h>
...
namespace controller{
	class trackingController{
		private:
			...
			xgc2_cerlab_tracking_controller::Target target_;
			ros::Time prevTime_;
			double deltaTime_;
		...
		public:
			...
			void targetCB(const xgc2_cerlab_tracking_controller::TargetConstPtr& target);
