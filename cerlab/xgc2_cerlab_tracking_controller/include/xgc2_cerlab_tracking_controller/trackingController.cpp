...
namespace controller{
	...
	void trackingController::registerPub(){
		...
		this->histTrajVisPub_ = this->nh_.advertise<nav_msgs::Path>("/xgc2_cerlab_tracking_controller/trajectory_history", 1);

		// target pose visualization publisher
		this->targetVisPub_ = this->nh_.advertise<geometry_msgs::PoseStamped>("/xgc2_cerlab_tracking_controller/target_pose", 1);
	
		// target trajectory history publisher
		this->targetHistTrajVisPub_ = this->nh_.advertise<nav_msgs::Path>("/xgc2_cerlab_tracking_controller/target_trajectory_history", 1); 

		// velocity and acceleration visualization publisher
		this->velAndAccVisPub_ = this->nh_.advertise<visualization_msgs::Marker>("/xgc2_cerlab_tracking_controller/vel_and_acc_info", 1);
	}
	...
	void trackingController::targetCB(const xgc2_cerlab_tracking_controller::TargetConstPtr& target){
		this->target_ = *target;
	...
	void trackingController::publishVelAndAccVis(){
        ...
        velAndAccVisMsg.ns = "xgc2_cerlab_tracking_controller";
