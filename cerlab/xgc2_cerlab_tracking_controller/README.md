...
cd ~/catkin_ws/src
git clone https://github.com/Zhefan-Xu/xgc2_cerlab_tracking_controller.git
...
For tracking a circular trajectory, please run the following commands. Note that the tracking circle function is a part of [xgc2_cerlab_autonomous_flight](https://github.com/Zhefan-Xu/xgc2_cerlab_autonomous_flight) package and please install it before running. Also, for simulator, you can either use the original PX4 simulator or use our PX4-based [uav_simulator](https://github.com/Zhefan-Xu/uav_simulator) package:
```
# start PX4 simulator
roslaunch uav_simulator px4_start.launch 

# launch the tracking node function with the tracking controller
roslaunch xgc2_cerlab_autonomous_flight takeoff_and_track_circle.launch
```
The example results of running the above command can be visulized as below:

https://github.com/Zhefan-Xu/xgc2_cerlab_tracking_controller/assets/55560905/5a83ede2-a8a2-4c7a-a5f4-3dd3304e9ad0

## III. Controller Structure
The implemented controller follows the structure shown below:

<img width="1410" alt="controller_diagram" src="https://github.com/Zhefan-Xu/xgc2_cerlab_tracking_controller/assets/55560905/b3a68c70-fb1a-4ec2-be29-3cb769670490">
...
## IV. Parameters
The controller parameters can be edited and modified in ```xgc2_cerlab_tracking_controller/cfg/controller_param.yaml```. 
...
Here lists some important ROS topics related to the controller:
  - Subscribing Topics:
    ...
    - ```/xgc2_cerlab_autonomous_flight/target_state```: The desired target states.
  ...
  - Publishing Topics:
    ...
    - ```/xgc2_cerlab_tracking_controller/robot_pose```: The robot current pose.
    - ```/xgc2_cerlab_tracking_controller/trajectory_history```: The robot historic trajectory.
    - ```/xgc2_cerlab_tracking_controller/target_pose```: The target current pose.
    - ```/xgc2_cerlab_tracking_controller/target_trajectory_history```: The target historic trajectory.
    - ```/xgc2_cerlab_tracking_controller/vel_and_acc_info```: The robot state information.
