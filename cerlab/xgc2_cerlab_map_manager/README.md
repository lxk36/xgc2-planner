...
This repo has been tested on ROS Melodic with Ubuntu 18.04 and ROS Noetic with Ubuntu 20.04 and it depends on [xgc2_cerlab_onboard_detector](https://github.com/Zhefan-Xu/xgc2_cerlab_onboard_detector) which provides the dynamic obstacle detection and tracking for our [dynamic map](https://ieeexplore.ieee.org/abstract/document/10161194). 

```
cd ~/catkin_ws/src
git clone https://github.com/Zhefan-Xu/xgc2_cerlab_map_manager.git
...
roslaunch xgc2_cerlab_map_manager occupancy_map.launch # check the launch file for ESDF map and dynamic map
roslaunch xgc2_cerlab_map_manager rviz.launch
```

The example of running occupancy map is shown as below (note that the robot is controlled by a keyboard):

https://github.com/Zhefan-Xu/xgc2_cerlab_map_manager/assets/55560905/40cca490-8613-4d12-ba4a-8b900d3e2cf0
...
![ESDF](https://github.com/Zhefan-Xu/xgc2_cerlab_map_manager/assets/55560905/e37243c6-eefe-4824-800d-1d8b35aaa74b)
...
```
roslaunch xgc2_cerlab_map_manager dynamic_map.launch
```

The example of the [dynamic map](https://ieeexplore.ieee.org/abstract/document/10161194) is shown below: 

![Screenshot from 2023-12-19 01-07-14](https://github.com/Zhefan-Xu/xgc2_cerlab_map_manager/assets/55560905/e9575308-c18f-49b0-9ed3-f5946478c8f5)
...
## III. Parameters
All mapping parameters can be edited and modified in ```xgc2_cerlab_map_manager/cfg/***.yaml``` files.
...
int main(){
  ...
  xgc2_cerlab_map_manager::ESDFMap m;
  m.initMap(nh);
  ...
  xgc2_cerlab_map_manager::dynamicMap dm;
  dm.init(nh)
