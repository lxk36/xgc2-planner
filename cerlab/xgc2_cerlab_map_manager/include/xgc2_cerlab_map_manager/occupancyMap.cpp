...
namespace mapManager{
	...
	bool occMap::checkCollision(xgc2_cerlab_map_manager::CheckPosCollision::Request& req, xgc2_cerlab_map_manager::CheckPosCollision::Response& res){
		if (req.inflated){
	...
	bool occMap::getRayCast(xgc2_cerlab_map_manager::RayCast::Request& req, xgc2_cerlab_map_manager::RayCast::Response& res){
