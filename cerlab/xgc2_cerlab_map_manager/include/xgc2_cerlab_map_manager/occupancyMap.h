...
#include <xgc2_cerlab_map_manager/raycast.h>
#include <xgc2_cerlab_map_manager/CheckPosCollision.h>
#include <xgc2_cerlab_map_manager/RayCast.h>
#include <thread>
...
namespace mapManager{
	...
	public:
		...
		// service
		bool checkCollision(xgc2_cerlab_map_manager::CheckPosCollision::Request& req, xgc2_cerlab_map_manager::CheckPosCollision::Response& res);		
		bool getRayCast(xgc2_cerlab_map_manager::RayCast::Request& req, xgc2_cerlab_map_manager::RayCast::Response& res);
