...
#define FLIGHTBASE_H
#include <ros/ros.h>
#include <xgc2_cerlab_autonomous_flight/px4/utils.h>
...
#include <xgc2_cerlab_tracking_controller/Target.h>
#include <Eigen/Dense>
#include <thread>
#include <mutex>
...
namespace AutoFlight{
	...
	protected:
		...
		xgc2_cerlab_tracking_controller::Target stateTgt_;
	...
	public:
		...
		void updateTargetWithState(const xgc2_cerlab_tracking_controller::Target& target);
	...
	struct trajData{
		...
		xgc2_cerlab_tracking_controller::Target getState(){
		...
		xgc2_cerlab_tracking_controller::Target getState(const geometry_msgs::Pose& psCurr){
			xgc2_cerlab_tracking_controller::Target target;
		...
		xgc2_cerlab_tracking_controller::Target getStateWithoutYaw(const geometry_msgs::Pose& psCurr){
			xgc2_cerlab_tracking_controller::Target target;
