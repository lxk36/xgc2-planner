...
#include <xgc2_cerlab_onboard_detector/fakeDetector.h>
...
namespace onboardDetector{
	fakeDetector::fakeDetector(const ros::NodeHandle& nh) : nh_(nh){
		...
		this->historyTrajPub_ = this->nh_.advertise<visualization_msgs::MarkerArray>("xgc2_cerlab_onboard_detector/history_trajectories", 10);
		this->histTimer_ = this->nh_.createTimer(ros::Duration(0.033), &fakeDetector::histCB, this);
		this->visPub_ = this->nh_.advertise<visualization_msgs::MarkerArray>("xgc2_cerlab_onboard_detector/GT_obstacle_bbox", 10);
    ...
    bool fakeDetector::getDynamicObstacles(xgc2_cerlab_onboard_detector::GetDynamicObstacles::Request& req, 
                                           xgc2_cerlab_onboard_detector::GetDynamicObstacles::Response& res) {
